...
import { handleUnSubscription } from "@externals/helpers/utils";
...
class HttpClient {
  ...
  constructor(args: ClientArg = {}) {
    this.host = args.host ?? envConfig.apiUrl;
  ...
  async request(method, url, data?: Object) {
