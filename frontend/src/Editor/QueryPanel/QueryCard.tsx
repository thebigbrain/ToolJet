...
export const QueryCard = ({
  ...
  const { deleteDataQueries, renameQuery, duplicateQuery } =
    useDataQueriesActions();
  ...
  return (
    <>
      <div
        className={
          "row query-row pe-2" + (isSeletedQuery ? " query-row-selected" : "")
        }
        key={dataQuery.id}
        onClick={() => {
            ...
            >
              ...
              >
                ...
                {!isQueryRunnable(dataQuery) && (
                  <small className="mx-2 text-secondary">Draft</small>
                )}
              </div>
            </OverlayTrigger>
          )}
        ...
        {!isVersionReleased && (
          <div className="col-auto query-rename-delete-btn">
            ...
            >
              ...
              >
                <Copy width={"16"} viewBox="0 5 20 20" />
              </span>
            </div>
