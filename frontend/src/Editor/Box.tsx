...
export const Box = function Box({
  ...
  const [validatedProperties, propertyErrors]: any =
    mode === "edit" && component.validate
      ? validateProperties(resolvedProperties, componentMeta.properties)
      : [resolvedProperties, []];

  const resolvedStyles: any = resolveStyles(
    component,
    currentState,
    null,
    customResolvables
  );
  const [validatedStyles, styleErrors]: any =
    mode === "edit" && component.validate
  ...
  const [validatedGeneralProperties, generalPropertiesErrors]: any =
    mode === "edit" && component.validate
  ...
  const [validatedGeneralStyles, generalStylesErrors]: any =
    mode === "edit" && component.validate
  ...
  useEffect(() => {
    ...
    if (renderCount > 10) {
      ...
      const timeDifference = Math.abs(
        currentTime.getMilliseconds() - renderStartTime.getMilliseconds()
      );
