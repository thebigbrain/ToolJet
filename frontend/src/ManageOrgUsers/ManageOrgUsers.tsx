...
type ManageOrgUsersComponentProps = {
  darkMode?: boolean;
  t?;
};

interface ManageOrgUsersComponentState {
  isLoading?: boolean;
  ...
  options?;
  file?;
  isInviteUsersDrawerOpen?: boolean;
  users?;
}

class ManageOrgUsersComponent extends React.Component<
  ManageOrgUsersComponentProps,
  ManageOrgUsersComponentState
> {
  constructor(props) {
    super(props);
          ...
          <div className="page-wrapper">
            <div>
              ...
              <div className="page-body">
                <UsersFilter filterList={this.filterList} />
