...
function getStyles(isDragging, isSelectedComponent): CSSProperties {
  return {
    position: "absolute",
...
export const DraggableBox = function DraggableBox({
  ...
  onDragStop = null,
  paramUpdated = null,
  resizingStatusChanged = null,
  zoomLevel = null,
  containerProps = null,
  setSelectedComponent = null,
  removeComponent = null,
  layouts = null,
  isSelectedComponent = null,
  draggingStatusChanged = null,
  darkMode = false,
  canvasWidth = null,
  readOnly = false,
  ...
  isMultipleComponentsSelected = null,
  childComponents = null,
  isVersionReleased = null,
}) {
