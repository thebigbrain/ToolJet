    ...
    if (searchTerm) {
      ...
      const filteredResults = allUserDefinedSources.filter(
        ({ name, kind }) =>
          ...
          kind.toLowerCase().includes(formattedSearchTerm)
      );
  ...
  return (
    <>
      ...
      <p className="mb-3" style={{ textAlign: "center" }}>
        Select a datasource to start creating a new query. To know more about
        queries in ToolJet, you can read our &nbsp;
        <a
          target="_blank"
