...
const CommentBody = ({
  ...
  const getContent = () => {
    if (isEmpty(thread))
      return (
        <div className="text-center">
          {t(
            "leftSidebar.Comments.commentBody",
    ...
    return (
      <div className="divide-y">
        {thread.map(({ id, comment, createdAt, user = {} }: any) => {
          return (
            <div key={id}>
              ...
              <div className="card-subtitle comment-time">
  ...
  return (
    <>
      <div
        className={cx(
          "comment-body card-body card-body-scrollable card-body-scrollable-shadow"
        )}
      >
        {getContent()}
