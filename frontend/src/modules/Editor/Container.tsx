...
import { addComponents, addNewWidgetToTheEditor } from "@/core/appUtils";
...
export const Container = ({
  ...
  const { appVersionsId, enableReleasedVersionPopupState, isVersionReleased } =
    useAppVersionStore(
      (state) => ({
  ...
  function updateCanvasHeight(components) {
    const maxHeight = Object.values<any>(components).reduce(
      (max, component) => {
