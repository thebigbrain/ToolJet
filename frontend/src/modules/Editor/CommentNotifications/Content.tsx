...
import {
  pluralize,
  hightlightMentionedUserInComment,
      ...
      return (
        <div className="empty">
          <p className="empty-title">
            {loading ? <Spinner /> : "No messages to show"}
          </p>
        </div>
      );
          ...
          return (
            ...
            >
              <div className="d-flex justify-content-between">
                ...
                <div
                  className={`comment-notification-count ms-auto ${
                    darkMode && "text-light"
                  }`}
                >
      ...
      <div className="card">
        {!loading && (
          <div className="card-header">
            <sub
              className={`fw-400 comment-notification-count ${
                darkMode ? "text-light" : "light-gray"
              }`}
            >
