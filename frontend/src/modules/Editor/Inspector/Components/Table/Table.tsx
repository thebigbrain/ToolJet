...
interface TableComponentState {
  ...
  components;
  currentState;
  actionPopOverRootClose: boolean;
  showPopOver: boolean;
}
...
> {
      ...
      >
        <Popover.Body>
          <div className="field mb-2" data-cy={`dropdown-column-type`}>
            ...
            <SelectSearch
              className={`${
                this.props.darkMode ? "select-search" : "select-search"
              }`}
              options={[
          ...
          <div className="field mb-2" data-cy={`input-and-label-column-name`}>
            ...
            <CodeHinter
              ...
              onChange={(value) =>
                this.onColumnItemChange(index, "name", value)
              }
  ...
  getPopoverFieldSource = (column, field) =>
    `component/${this.props.component.component.name}/${
      column ?? "default"
    }::${field}`;
  ...
  render() {
    ...
    const enabledSort = component.component.definition.properties.enabledSort
      ...
      : true;
    const useDynamicColumn = component.component.definition.properties
      .useDynamicColumn?.value
      ? resolveReferences(
    ...
    const allowSelection = component.component.definition.properties
      ?.allowSelection?.value
      ? resolveReferences(
          component.component.definition.properties.allowSelection?.value,
          currentState
        )
      : resolveReferences(
        ...
        resolveReferences(
          component.component.definition.properties.showBulkSelector.value,
          currentState
        );
    ...
    items.push({
      ...
      children: (
        <div>
                            ...
                            {(provided, snapshot) => (
                              ...
                              >
                                <OverlayTrigger
                                  ...
                                  placement="left"
                                  rootClose={
                                    this.state.popOverRootCloseBlockers
                                      .length === 0
                                  }
          ...
          <div style={{ marginTop: useDynamicColumn ? "0px" : "30px" }}>
    ...
    const options = [
      ...
      "allowSelection",
      ...(allowSelection
        ? ["highlightSelectedRow", "showBulkSelector", "defaultSelectedRow"]
        : []),
