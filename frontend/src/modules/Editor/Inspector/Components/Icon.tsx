...
export function Icon({ componentMeta = {}, darkMode = false, ...restProps }) {
  const {
          ...
          <div className="row">
            {
              <VirtuosoGrid
                ...
                itemContent={(index) => {
                  if (
                    filteredIcons[index] === undefined ||
                    filteredIcons[index] === "createReactComponent"
                  )
                    return null;
