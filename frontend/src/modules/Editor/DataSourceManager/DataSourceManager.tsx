...
class DataSourceManagerComponent extends React.Component<any, any> {
  constructor(props) {
    super(props);
  ...
  createDataSource = () => {
    ...
    if (name.trim() !== "") {
      let service =
        scope === "global" ? globalDatasourceService : datasourceService;
  ...
  renderSourceComponent = (kind, isPlugin = false) => {
    ...
    const ComponentToRender = isPlugin
      ? SourceComponent
      : SourceComponents[sourceComponentName] || SourceComponent;
    return (
      <ComponentToRender
    ...
    const dataSourceList = [
      {
        ...
        renderDatasources: () =>
          this.renderCardGroup(allDataSourcesList, "All Datasources"),
      },
      {
        type: "Databases",
        key: "#databases",
        ...
        renderDatasources: () =>
          this.renderCardGroup(allDataSourcesList.databases, "Databases"),
      },
      {
        type: "APIs",
        key: "#apis",
        ...
        renderDatasources: () =>
          this.renderCardGroup(allDataSourcesList.apis, "APIs"),
      },
      {
        type: "Cloud Storage",
        key: "#cloudstorage",
      ...
      },
      {
        ...
        renderDatasources: () =>
          this.renderCardGroup(allDataSourcesList.plugins, "Plugins"),
      },
      {
        ...
        renderDatasources: () =>
          this.renderCardGroup(
            this.state.filteredDatasources,
            this.state.activeDatasourceList
          ),
      },
    ];
    ...
    return (
      <div>
            ...
            <Modal.Footer>
              ...
              <div className="col-auto" data-cy="db-connection-save-button">
                <ButtonSolid
                  ...
                  isLoading={isSaving}
                  disabled={
                    isSaving || this.props.isVersionReleased || isSaveDisabled
                  }
                  variant="primary"
                  onClick={this.createDataSource}
                  leftIcon="floppydisk"
                  fill={
                    this.props.darkMode && this.props.isVersionReleased
                      ? "#4c5155"
                      : "#FDFDFE"
                  }
                >
        ...
        <ConfirmDialog
          ...
          onConfirm={() =>
            createSelectedDataSource(dataSourceConfirmModalProps.dataSource)
          }
...
export const DataSourceManager = withTranslation()(
  withRouter(withStore(DataSourceManagerComponent))
);
