...
const BLOCK_TYPES = [
  {
    label: (
      <img src="assets/images/icons/rich-text-editor/blockquote.svg" alt="blockquote" style={{ height: '16px' }} />
    ),
    style: 'blockquote',
  },
  {
    label: <img src="assets/images/icons/rich-text-editor/ul.svg" alt="ul" style={{ height: '16px' }} />,
    style: 'unordered-list-item',
  },
  {
    label: <img src="assets/images/icons/rich-text-editor/ol.svg" alt="ol" style={{ height: '16px' }} />,
    style: 'ordered-list-item',
  },
  {
    label: <img src="assets/images/icons/rich-text-editor/codeblock.svg" alt="codeblock" style={{ height: '16px' }} />,
    style: 'code-block',
  },
];
