...
export const LeftSidebarInspector = ({
  ...
  const componentDefinitions = JSON.parse(JSON.stringify(appDefinition))[
    "components"
  ];
  ...
  const queryIcons = Object.entries<any>(currentState["queries"]).map(
    ([key, value]) => {
  ...
  const componentIcons = Object.entries<any>(currentState["components"]).map(
    ([key, value]) => {
      ...
      if (!_.isEmpty(component) && component.name === key) {
        return {
          ...
          iconPath: `assets/images/icons/widgets/${
            component.component.toLowerCase() === "radiobutton"
              ? "radio-button"
      ...
      <HeaderSection darkMode={darkMode}>
        <HeaderSection.PanelHeader title="Inspector">
          <div className="d-flex justify-content-end">
            ...
            >
              <Button.Content
                iconSrc={`assets/images/icons/editor/left-sidebar/pinned${
                  pinned ? "off" : ""
                }.svg`}
                direction="left"
              />
