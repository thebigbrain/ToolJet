...
type LeftSidebarCommentProps = {
  selectedSidebarItem;
  currentPageId;
};

export const LeftSidebarComment = forwardRef<any, LeftSidebarCommentProps>(
  ({ selectedSidebarItem, currentPageId }, ref) => {
    ...
    return (
      <LeftSidebarItem
        ...
        className={cx(
          `left-sidebar-item left-sidebar-layout sidebar-comments`,
          {
