...
export const LeftSidebar = forwardRef<{}, LeftSidebarProps>((props, ref) => {
  ...
  const [selectedSidebarItem, setSelectedSidebarItem] = useState(
    dataSources?.length === 0 && prevSelectedSidebarItem === "database"
      ? "inspect"
  ...
  const setSideBarBtnRefs = (page: string) => (ref: HTMLElement) => {
  ...
  return (
    <div className="left-sidebar" data-cy="left-sidebar-inspector">
      ...
      <ConfirmDialog
        ...
        onConfirm={() => router.navigate("/")}
        onCancel={() => setShowLeaveDialog(false)}
        darkMode={darkMode}
        title={undefined}
        confirmButtonLoading={undefined}
