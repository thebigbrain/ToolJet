...
const Footer = ({
  ...
  const { selectedTable, totalRecords, buildPaginationQuery } = useContext(
      ...
      <div className="table-footer row gx-0" data-cy="table-footer-section">
        <div className="col-5" data-cy="add-new-row-button">
          ...
          >
            <Button.Content
              title={"Add new row"}
              iconSrc={"assets/images/icons/add-row.svg"}
              direction="left"
            />
          </Button>
        </div>
        {tableDataLength > 0 && (
          <div className="col d-flex align-items-center justify-content-end">
            ...
            <div
              className="col mx-2 records-dropdown-field"
              data-cy="records-dropdown-field"
            >
              <Select
            ...
            <div className="col-4 mx-2" data-cy="total-records-section">
              {dataLoading ? (
                ...
                <span
                  ...
                  data-cy={`${pageRange}-of-${totalRecords}-records-text}`}
                >
