...
import { PasswordResetinfoScreen } from "@/modules/SuccessInfoScreen";
...
type ResetPasswordState = Partial<{
  isLoading: boolean;
  token: string;
  email: string;
  password: string;
  showResponseScreen: boolean;
  showPassword: boolean;
  password_confirmation: string;
  showConfirmPassword: boolean;
}>;

class ResetPasswordComponent extends React.Component<any, ResetPasswordState> {
  constructor(props) {
    super(props);
