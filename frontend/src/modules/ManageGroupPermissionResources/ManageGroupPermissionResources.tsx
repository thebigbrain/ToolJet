...
interface ManageGroupPermissionResourcesState {
...
class ManageGroupPermissionResourcesComponent extends React.Component<
  ManageGroupPermissionResourcesProps,
  ManageGroupPermissionResourcesState
> {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const searchSelectClass = this.props.darkMode
      ? "select-search-dark"
      : "select-search";
            ...
            <div>
              <div className="justify-content-between d-flex groups-main-header-wrap">
                <p
                  ...
                  data-cy={`${this.props.selectedGroup
                    .toLowerCase()
                    .replace(/\s+/g, "-")}-title`}
                >
                ...
                <div className="tab-content">
                  ...
                  >
                    {groupPermission?.group !== "admin" && (
                      <div className="row">
                        <div
                          className="manage-groups-app-dropdown"
                          data-cy="select-search"
                        >
                          <Multiselect
                          ...
                          {groupPermission.group == "admin" && (
                            <div className="manage-group-users-info">
                              ...
                              >
                                ...
                                Admin has edit access to all apps. These are not
                                editable
                              </p>
                            </div>
                          )}
                  ...
                  >
                    ...
                    <div>
                      {groupPermission.group == "all_users" && (
                        <div
                          className="manage-group-users-info"
                          data-cy="helper-text-all-user-included"
                        >
                          <p className="tj-text-xsm">
                            <SolidIcon name="information" fill="#3E63DD" /> All
                            users include every users in the app. This list is
                            not editable
                          </p>
                        </div>
                      )}
                        ...
                        {isLoadingGroup || isLoadingUsers ? (
                          ...
                          usersInGroup.map((user) => (
                            <div
                              ...
                              data-cy={`${String(user.email)
                                .toLowerCase()
                                .replace(/\s+/g, "-")}-user-row`}
                            >
                        ...
                        <div>
                          {groupPermission.group == "admin" && (
                            <div className="manage-group-users-info">
                              <p
                                className="tj-text-xsm"
                                data-cy="helper-text-admin-permissions"
                              >
                                <SolidIcon name="information" fill="#3E63DD" />{" "}
