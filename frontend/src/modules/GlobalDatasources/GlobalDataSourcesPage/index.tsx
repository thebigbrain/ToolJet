...
import { SearchBox as _SearchBox } from "@/_components";
...
export const GlobalDataSourcesPage = ({
  darkMode = false,
  ...
  const handleSearch = (e) => {
    ...
    const arr = [];
    const filteredDatasources = datasourcesGroups().filter(
  ...
  const createDataSource = (dataSource) => {
    ...
    const selectedDataSource =
      dataSource.manifestFile?.data?.source ?? dataSource;
    ...
    const options =
      ...
      (dataSource.manifestFile.data.defaults ??
        dataSource.manifestFile.data.options);
    const pluginId = id;
  ...
  const segregateDataSources = () => {
    ...
    const searchPlaceholder = datasources.filter(
      (ds) => ds.key === activeDatasourceList
    )[0];
    ...
    const dataSourceList = [
      {
        ...
        renderDatasources: () => renderCardGroup(allDataSourcesList),
      },
      {
        type: "Databases",
        key: "#databases",
        list: allDataSourcesList.databases,
        renderDatasources: () => renderCardGroup(allDataSourcesList.databases),
      },
      {
        type: "APIs",
        key: "#apis",
        list: allDataSourcesList.apis,
        renderDatasources: () => renderCardGroup(allDataSourcesList.apis),
      },
      {
        type: "Cloud Storage",
        key: "#cloudstorage",
        ...
        renderDatasources: () =>
          renderCardGroup(allDataSourcesList.cloudStorages),
      },
      {
        type: "Plugins",
        key: "#plugins",
        list: allDataSourcesList.plugins,
        renderDatasources: () => renderCardGroup(allDataSourcesList.plugins),
      },
      {
        type: "Filtered Datasources",
        key: "#filtereddatasources",
        list: allDataSourcesList.filteredDatasources,
        renderDatasources: () => renderCardGroup(filteredDataSources),
      },
    ];
