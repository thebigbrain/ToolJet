...
import { ManageGroupPermissionResources } from "@/modules/ManageGroupPermissionResources";
...
type ManageGroupPermissionsComponentProps = {
  darkMode?: boolean;
  t?;
};

interface ManageGroupPermissionsComponentState {
  isLoading?: boolean;
  groups?;
  ...
  showGroupDeletionConfirmation?: boolean;
  showGroupNameUpdateForm?: boolean;
  groupToBeUpdated?;
...
class ManageGroupPermissionsComponent extends React.Component<
  ManageGroupPermissionsComponentProps,
  ManageGroupPermissionsComponentState
> {
  constructor(props) {
    super(props);
                      ...
                      <FolderList
                        ...
                        onClick={() => {
                          this.setState({
                            ...
                            selectedGroup: this.humanizeifDefaultGroupName(
                              permissionGroup.group
                            ),
                          });
                        }}
                        className="groups-folder-list"
                        dataCy={this.humanizeifDefaultGroupName(
                          permissionGroup.group
                        )
                          .toLowerCase()
                          .replace(/\s+/g, "-")}
