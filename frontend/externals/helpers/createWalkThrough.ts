...
import { addToLocalStorage, getDataFromLocalStorage } from "@/core/appUtils";
    ...
    driver.defineSteps([
      {
        ...
        popover: {
          ...
          description:
            "From the component sidebar, drag and drop components to the canvas.",
          position: "left",
      ...
      },
      {
        ...
        popover: {
          title: "Inspector",
          description:
            "Inspector lets you check the properties of components, results of queries etc.",
          position: "right",
